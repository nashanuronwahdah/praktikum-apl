...
//AKUN ADMIN DENGAN NAMA DAN NIM
...
void tandaiSlotTerisi() {
    ...
    if (wilayah[indeks].slot[idSlot-1].terisi) {
        cout << "Slot sudah terisi sebelumnya.\n";
    } else {
        wilayah[indeks].slot[idSlot-1].terisi = true;
        cout << "Slot " << idSlot << " di wilayah " << nama << " ditandai terisi.\n";
    }
}
...
void pesanMakam() {
    ...
    while (true) {
        ...
        wilayah[indeksWilayah].slot[nomorSlot-1].terisi = true;
        wilayah[indeksWilayah].slot[nomorSlot-1].namaJenazah = namaJenazah;
        wilayah[indeksWilayah].slot[nomorSlot-1].namaOrtu = namaOrtu;
        wilayah[indeksWilayah].slot[nomorSlot-1].tanggalWafat = tanggalWafat;
